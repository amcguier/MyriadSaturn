...
[<assembly: AssemblyTitleAttribute("MyriadSaturn.Tests")>]
[<assembly: AssemblyProductAttribute("MyriadSaturn")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "MyriadSaturn.Tests"
    let [<Literal>] AssemblyProduct = "MyriadSaturn"
